...
This page is a living list of open-source software and publicly accessible resources for quantitative face-perception research. It is adapted from the software/resource table accompanying *Quantifying Face Perception: From Morphology to Predictive Models* and is organized by the role each resource can play in stimulus modeling, measurement, model fitting, or interpretation.
